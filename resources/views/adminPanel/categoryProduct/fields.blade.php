...
<div class="tab-content" id="pills-tabContent">
    ...
    <div class="tab-pane fade {{request('languages') == $locale?'show active':''}}" id="{{$name}}" role="tabpanel" aria-labelledby="{{$name}}-tab">
        ...
        <div class="form-group col-sm-6">
            {!! Form::label('name', __('models/categoryProduct.fields.name').':') !!}
    ...
    <div class="form-group col-sm-6">
        {!! Form::label('type', __('models/categoryProduct.fields.type').':') !!}
    ...
    <div class="form-group col-sm-12">
        ...
        <a href="{{ route('adminPanel.categoryProduct.index') }}" class="btn btn-default">@lang('crud.cancel')</a>
    </div>
